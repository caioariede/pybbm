...
from pybb_core.loading import get_models, get_form, get_forms, get_classes
...
PaginatorMixin, RedirectToLoginMixin, BreadcrumbMixin, \
    PermissionsMixin, perms = get_classes('mixins', [
        'PaginatorMixin', 'RedirectToLoginMixin', 'BreadcrumbMixin',
        'PermissionsMixin',
        'perms',
    ])
